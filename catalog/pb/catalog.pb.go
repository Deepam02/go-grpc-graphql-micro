...
var file_catalog_proto_rawDesc = string([]byte{
	...
	0x72, 0x69, 0x76, 0x63, 0x65, 0x12, 0x40, 0x0a, 0x0b, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x72, 0x6f,
...
var file_catalog_proto_depIdxs = []int32{
	...
	1, // 3: pb.CatalogSerivce.PostProduct:input_type -> pb.PostProductRequest
	3, // 4: pb.CatalogSerivce.GetProduct:input_type -> pb.GetProductRequest
	5, // 5: pb.CatalogSerivce.GetProducts:input_type -> pb.GetProductsRequest
	2, // 6: pb.CatalogSerivce.PostProduct:output_type -> pb.PostProductResponse
	4, // 7: pb.CatalogSerivce.GetProduct:output_type -> pb.GetProductResponse
	6, // 8: pb.CatalogSerivce.GetProducts:output_type -> pb.GetProductsResponse
